...
\fancyhead[LO]{\hyperlink{s:toc}{2026 Computing Expo --- List of Projects}}


\def\PHOTOwidth{3.3cm}
\tikzset{%
    DEBUG/.style = {},
...
{%
	...
	\setcounter{page}{1}
	%
	\input{../common_content/Welcome_Amanda}
	\input{../common_content/Welcome_Lucy}
...
\input{HDip_in_Computer_Science_content.tex}
...
\input{MSc_in_Computer_Science_Enterprise_Software_Systems_content.tex}
\input{MSc_in_Computing_Information_Systems_Processes_content.tex}
