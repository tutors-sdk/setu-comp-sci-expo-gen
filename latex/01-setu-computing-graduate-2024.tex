...
% !TEX root =  ../output/CExpo_2024_-_Project_Brochure.tex
% !TEX root =  ../output/CExpo_2024_-_List_of_Projects.tex
...
\newcommand\typesetPoster{%
	...
	\IfFileExists{\POSTER}{%
		...
		\ifbool{isPosterLandscape}{
			...
			\includegraphics[height=13.5cm]{\POSTER}%
		}%
	}{}%
}
...
\begin{tikzpicture}
	...
	\node[anchor=north west,scale=1.4] 
		at ($(COMMERICAL_TITLE.north west)+(20.1,0.2)$) 
		{\typesetLocation};
	...
	\ifbool{isPosterLandscape}{%
		...
		\def\POFFSET{-6.1}
		\ifdefstring{\Key}{Tibor_Molnar_10FA0}{\gdef\POFFSET{-7.1}}{}
		\ifdefstring{\Key}{Isadora_Fitzgerald_C1597}{\gdef\POFFSET{-7.1}}{}
		\ifdefstring{\Key}{Grzegorz_Piotrowski_BAF94}{\gdef\POFFSET{-7.1}}{}
...
%	\node[SUMMARY,text width=20cm] at ($(NAME.south east)+(0,0)$) (SUMMARY) {\typesetSummary};
	\node[TECHNOLOGIES,text width=21.5cm] 
		at ($(A_TITLE.south west)+(-1,-0.3)$) (TECHNOLOGIES) 
		{\typesetTechnologies};
